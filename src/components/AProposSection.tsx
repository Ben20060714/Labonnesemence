...
export default function AProposSection() {
  ...
  const croyancesFondatrices = [
    ...
    },
    {
      ...
      description: 'Être là et accompgner tous les enfants dans leur marche sur le chemin de la foi et de les soutenirs dans chaque moment.'
    },
    {
      titre: 'L’Engagement',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-6 text-left">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl font-bold text-slate-900 leading-tight dark:text-slate-100">
            Une église Centenaire, Un Esprit Résolument Contemporain
          </h1>
          ...
          <div className="space-y-4 text-sm sm:text-base text-slate-600 font-light leading-relaxed dark:text-slate-400">
            <p>
              Fondée en **** au cœur de la ville, l'église est devenue au fil des générations un lieu d'ancrage spirituel incontournable pour des milliers de familles chretiennes.
            </p>
          </div>
        </div>
            ...
            >
              ...
              <div className="space-y-2 text-xs font-mono text-slate-500 pt-2 dark:text-slate-450 border-t border-slate-50 dark:border-slate-850">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>Membre de la bone semence depuis 2020</span>
                </div>
              </div>
