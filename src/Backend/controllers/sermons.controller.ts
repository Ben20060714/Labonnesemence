...
export const create = async (req: Request, res: Response) => {
  ...
  try {
    ...
    try {
      await sendTopicNotification('Nouveau Sermon disponible !', titre || 'Un nouveau sermon vient d’être publié.');
    } catch (notificationError: any) {
      console.error('Notification Firebase Sermon échouée:', notificationError);
    }
  } catch (error: any) {
