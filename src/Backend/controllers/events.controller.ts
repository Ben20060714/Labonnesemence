...
export const create = async (req: Request, res: Response) => {
  ...
  try {
    ...
    try {
      await sendTopicNotification('Nouvel Événement !', titre || 'Un nouvel événement a été publié.');
    } catch (notificationError: any) {
      console.error('Notification Firebase Événement échouée:', notificationError);
    }
  } catch (error: any) {
